# 背景和目的
- 定期跟进链上已经发生的攻击活动，给团队成员长期的安全sense培养
- 先了解黑客实际怎么利用漏洞，再了解黑客怎么发现的漏洞，才能最终在设计上反推减轻或避免漏洞
  - 知其然，更要知其所以然，才能防患于未然
  - 发现已经被攻击的结果并理解原理，和发现可被攻击的漏洞是2个难度完全不同的点
    - 链上的公开透明特性，加上AI时代的发展，后者的难度正在迅速降低。
- 简单的意见收集，balancer攻击后，下一个感兴趣的分析选题 
